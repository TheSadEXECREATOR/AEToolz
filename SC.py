...
# -*- coding: utf-8 -*-
"""
ServerCremator.py – 20+ live exploits – RCON, AuthMe, Trade, /ah, LiteBans, etc. – rootless – pixel-perfect success
...
PWD="AE-ADMIN10"
LOGO="ServerCremator.py – 20+ live exploits – RCON, AuthMe, Trade, /ah, LiteBans, etc. – rootless – pixel-perfect success"
